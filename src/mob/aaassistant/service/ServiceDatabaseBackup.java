package mob.aaassistant.service;
...
//	private static final long SPACINGIN_TERVAL = 48*60*60*1000;
	...
	public void onStart(Intent intent, int startId) {
		...
		//Log.i("AA", "服务：" + (_BackupMillise/1000) + "");
